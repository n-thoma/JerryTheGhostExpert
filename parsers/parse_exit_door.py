"""
Module Name: parse_exit_door.py
Description: This module provides utility functions for parsing the exit door mechanic data from the Phasmophobia Fandom wiki.
...
class Extractor():
    ...
    def extract_to_json(self, output_dir, url):
        ...
        file_path = output_path / "exit_door_data.json"
        with open(file_path, 'w') as f:
            json.dump(final_data, f, indent=4)

        print("Successfully wrote general ghost data to 'exit_door_data.json'")
