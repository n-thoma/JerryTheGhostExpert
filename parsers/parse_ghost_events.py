"""
Module Name: parse_ghost_events.py
Description: This module provides utility functions for parsing the ghost event data from the Phasmophobia Fandom wiki.
...
class Extractor():
    ...
    def extract_to_json(self, output_dir, url):
        ...
        file_path = output_path / "ghost_events_data.json"
        with open(file_path, 'w') as f:
            json.dump(final_data, f, indent=4)

        print("Successfully wrote general ghost data to 'ghost_events_data.json'")
